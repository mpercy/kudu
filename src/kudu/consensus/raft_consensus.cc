...
// Proxying metrics.
METRIC_DEFINE_counter(tablet, raft_proxy_num_requests_received,
...
METRIC_DEFINE_counter(tablet, raft_proxy_num_requests_success,
                      ...
                      "delivered.",
                      kudu::MetricLevel::kInfo);
METRIC_DEFINE_counter(tablet, raft_proxy_num_requests_unknown_dest,
                      ...
                      kudu::MetricLevel::kWarn);
METRIC_DEFINE_counter(tablet, raft_proxy_num_requests_log_read_timeout,
                      ...
                      kudu::MetricLevel::kWarn);
METRIC_DEFINE_counter(tablet, raft_proxy_num_requests_hops_remaining_exhausted,
