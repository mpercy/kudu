...
class RaftConsensus : public Consensus,
 ...
 public:
  ...
  virtual Status WaitUntilLeader(const MonoDelta& timeout) OVERRIDE;
 ...
 private:
  ...
  // Returns OK and sets 'only_voter' if this node is the only voter in the
  // Raft configuration for the tablet.
  Status IsSingleVoterConfig(bool* only_voter) const;
